...
public class DropDownComponent<T extends DropDownComponent.SelectionEntry<?>> extends AbstractWidget {
    ...
    public DropDownComponent(int x, int y, int width, Component title, Consumer<T> selectCallback) {
