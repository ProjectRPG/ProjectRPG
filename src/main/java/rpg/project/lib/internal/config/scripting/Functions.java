...
//        });
        ...
        TARGETORS.put("config", (param, access) -> new TargetSelector.Selection(ObjectType.PLAYER, List.of(Reference.resource("prpg:"+param))));
...
//        ResourceLocation attrId = Reference.resource(match.group(1));
